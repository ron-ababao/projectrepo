...
if __name__ == '__main__':
    ...
    creation=create_sns_topic('ron-ababao-TOPIC-INFO')
    log.info(creation)
    
    creation=create_sns_topic('ron-ababao-TOPIC-WARNING')
    log.info(creation)
    
    creation=create_sns_topic('ron-ababao-TOPIC-ERROR')
    log.info(creation)
    
    creation=create_sns_topic('ron-ababao-TOPIC-CRITICAL')
    log.info(creation)
    
    list_sns=list_sns_topics()
    log.info(list_sns)
    
    subs_topic=subscribe_sns_topic('arn:aws:sns:us-east-1:337008671328:ron-ababao-TOPIC-INFORMATION','+639176882777')
    log.info(subs_topic)
    
    subs_topic=subscribe_sns_topic('arn:aws:sns:us-east-1:337008671328:ron-ababao-TOPIC-ERROR','+639278882909')
    log.info(subs_topic)
    
    subs_topic=subscribe_sns_topic('arn:aws:sns:us-east-1:337008671328:ron-ababao-TOPIC-INFO','+639278882909')
    log.info(subs_topic)
    
    subs_topic=subscribe_sns_topic('arn:aws:sns:us-east-1:337008671328:ron-ababao-TOPIC-WARNING','+639278882909')
    log.info(subs_topic)
...
'''
    ...
    send_message=send_sns_message('arn:aws:sns:us-east-1:337008671328:ron-ababao-TOPIC-CRITICAL', 'Diin ta boy')
